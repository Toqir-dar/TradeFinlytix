    ...
    <div suppressHydrationWarning style={{ minHeight: "100vh", display: "flex", fontFamily: "'DM Sans', 'Segoe UI', sans-serif" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-right { width: 50%; display: flex; flex-direction: column; justify-content: center; padding: 60px 64px; background: ${th.rightBg}; overflow-y: auto; }
      ...
      <div className="auth-right">
        <div style={{ maxWidth: 400, width: "100%" }} className="fade-in">
          <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 34, color: th.text, marginBottom: 8, letterSpacing: "-0.5px" }}>
            Create your account
          </h1>
          <p style={{ fontSize: 15, color: th.subtext, marginBottom: 32 }}>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: "block", fontSize: 14, fontWeight: 600, color: th.labelColor, marginBottom: 6 }}>Full Name</label>
            ...
            <div style={{ marginBottom: 24 }}>
              <label style={{ display: "block", fontSize: 14, fontWeight: 600, color: th.labelColor, marginBottom: 6 }}>Confirm Password</label>
            ...
            <button type="submit" className="btn-submit" disabled={loading}>
              {loading ? (
                ...
                <>Create Account <ArrowRight size={16} color="white" strokeWidth={2} /></>
              )}
            </button>
          </form>
